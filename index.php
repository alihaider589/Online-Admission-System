    ...
    <body  style="background-image:url('./images/11.jpg');" >
        <form id="index" action="index.php" method="post">
            ...
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/smiuindex.jpg" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
                            ...
                            <div id="dmain" style="margin-left:600px; margin-top:200px;"> 
                                <br>
                                    ...
                                    <a href="signup.php" style="margin-left: 180px; color:white;">Sign Up </a>
