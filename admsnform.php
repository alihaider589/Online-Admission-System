               ...
               <tr>
                ...
                <tr>
                     ...
                     <td><select id="cen" name="cen">
                         <option>--------------------Select--------------------</option>
                         <option>SMIU Main Campus</option>
                         <option>Malir DHA Campus</option>
                         </select>
                     </td>
                   ...
                   <td colspan="3">
                       <table class="table table-hover">
                           ...
                           <tr>
                               ...
                               <td colspan="3">
                                    <input type="radio" id="moi" name="moi" value="Odia">Urdu
                                    ...
                                    <input type="radio" id="moi" name="moi" value="Telugu"><font style="font-family: Verdana;">Sindhi</font>
                                    <input type="radio" id="moi" name="moi" value="Bengali"><font style="font-family: Verdana;">Punjabi</font>
