...
<html>
     ...
     <body style="background-image:url('./images/inbg.jpg');">
        <form id=viform" action="viewform.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/adminlogin.jpg" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
             </div><br>
                <div  class="container-fluid">  
  ...
  <div class="container-fluid">
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><img src="./images/smiu-logo.png" width="50%"> </td>
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                    SINDH MADRESSATUL ISLAM UNIVERISITY , KARACHI </font></center>
